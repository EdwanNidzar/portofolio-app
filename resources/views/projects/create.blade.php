          ...
          <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
              <label for="name_project" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Project
                Name</label>
              <input name="name_project" type="text" placeholder="Project Name"
            ...
            <div class="mb-4">
              <label for="demo" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Link
                Demo</label>
              <input name="demo" type="text" placeholder="Masukan Link Demo Jika Ada" class="input input-bordered w-full" />
            </div>
            @error('demo')
              <div class="alert alert-error">
                <span>{{ $message }}</span>
            ...
            <div class="mb-4">
              <label for="github" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Link
                Github</label>
              <input name="github" type="text" placeholder="Masukan Link Github Jika Ada" class="input input-bordered w-full" />
            </div>
            @error('github')
              <div class="alert alert-error">
                <span>{{ $message }}</span>
            ...
            <div class="mb-4" x-data="{ avatarPreview: '' }">
